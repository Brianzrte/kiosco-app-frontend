...
const order = (id: string, status: "PENDING" | "RECEIVED", pending = false) => ({ id, supplier_name: "Proveedor", ordered_at: "2026-01-01T00:00:00Z", expected_at: null, total: "1.00", status, has_uncatalogued_items: pending });
