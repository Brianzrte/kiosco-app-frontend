...
| `roles/frontend-feature-orchestrator.md` | `skills/orchestrate-frontend-change/SKILL.md` | Coordinar implementación, auditoría UX/UI, review y verificación de un feature. |
