# ui-cashier-shift-closing

> Bloqueado por backend. Ninguna de las siguientes requirements se implementa hasta que los endpoints pedidos en `backend-request.md` existan y estén desplegados. Ver `design.md` para la investigación que confirma la ausencia.
